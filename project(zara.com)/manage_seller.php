...
<form action="controller/managing_seller.php" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="status"  placeholder="Enter status">
...
<a href="buyer_edit.php?edit='.$row['id'].'"class="btn btn-info"> Edit</a>
<a href="controller/managing_seller.php?delete='.$row['id'].'"class="btn btn-info"> Delete</a>
<a href="managing_seller.php?profile='.$row['id'].'"class="btn btn-info"> View Profile</a>
