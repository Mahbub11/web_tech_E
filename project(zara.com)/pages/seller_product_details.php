...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="seller_admin_panel.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to index</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>   
       ...
       <ul>
       <?php echo "<a href=\"seller_product_update.php?prod_id=$res[prod_id]\">Edit Product Details</a>"; }?>
       </ul>
       <?php 
    }
?>      
