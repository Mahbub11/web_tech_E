    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_panel.php" class="navbar-brand" rel="tooltip" title="" data-placement="bottom" target="">
                    Zara Fashion
                </a>
                                            ...
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                               ...
                                               <?php } 
                                                ...
                                                echo "<td><a href=\"product_update.php?prod_id=$res[prod_id]\">Edit</a> | <a href=\"product_delete.php?prod_id=$res[prod_id]
