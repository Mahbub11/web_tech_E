...
<form action="controller/managing_seller.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" value= <?php echo $status; ?> name="status"  placeholder="Enter status">
